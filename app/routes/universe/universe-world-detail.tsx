  ...
  return (
    <>
      <div className="flex-1 p-6">
        {/* World Description */}
        <section className="bg-white p-6 border border-gray-200 mb-8 shadow-xs">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {worldStats.map(stat => (
            <div key={stat.name} className="bg-white p-5 border border-gray-200 flex items-center space-x-4 shadow-xs">
      ...
      <div className="pt-6 pr-6 shrink-0">
        <div className="bg-white border border-gray-200 shadow-xs">
          <RightSidebar />
        </div>
      </div>
